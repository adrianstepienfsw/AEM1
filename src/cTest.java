...
public class cTest {
    ...
    public static void main(String[] args) {
        ...
        //localSearchSteepestCornersSample2.make();

        localSearchSteepestCornersListMovesSample1.testAlgorithm(50, "Making Local Search Steepest (changing with corners) Algorithm using List Moves from previous step for :"+sample1.name);
        localSearchSteepestCornersListMovesSample2.testAlgorithm(50, "Making Local Search Steepest (changing with corners) Algorithm using List Moves from previous step for :"+sample2.name);
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                //new cMyFrame(sample2,  localSearchSteepestPointsSample2.listOfResults.get(localSearchSteepestPointsSample2.minDistanceIndex-1), localSearchSteepestPointsSample2.getClass().getName());
