...
Powtarzaj:
    Wygeneruj listę możliwych ruchów:
        Zainicjalizuj pustą listę zwracanych ruchów.
        Wygeneruj punkty poza rozwiązaniem.
        Dla każdego ruchu:
            ...
            W przeciwnym wypadku dla zamiany krawędzi:
                Dla każdego punktu w rozwiązaniu:
                    Dla każdego punktu w rozwiązaniu poza punktem wybranym w otaczającej pętli:
                        Oblicz deltę.
                        Dodaj ruch do listy zwracanych ruchów.
    ...
    Jeżeli rozwiązanie jest puste albo jest lepsze od aktualnego to wybierz znalezione rozwiązanie z najlepszym ruchem.
\end{lstlisting}
...
Powtarzaj dopóki nie osiągnięto określonego czasu:
    Wykonaj perturbację:
        ...
        Zamień punkty z rozwiązania z wylosowanymi punktami.
    Powtarzaj:
        Wygeneruj listę możliwych ruchów:
            Zainicjalizuj pustą listę zwracanych ruchów.
            Wygeneruj punkty poza rozwiązaniem.
        ...
        Wykonaj najlepszy ruch:
            Jeżeli lista ruchów nie jest pusta:
                Jeżeli delta pierwszego ruchu z listy jest mniejsza od zera:
                    ...
                    W przeciwnym wypadku dla zamiany krawędzi zamień ze sobą krawędzie.
        Jeżeli nie można wykonać najlepszego ruchu to przerwij pętlę.
    Jeżeli rozwiązanie po wykonaniu perturbacji jest lepsze od aktualnego rozwiązania, to zapisz znalezione rozwiązanie jako aktualne rozwiązanie.
\end{lstlisting}
...
ISL1:
\begin{itemize}
    \item Average number of LocalSearch Iterations 544.8 for :kroA200.tsp
    \item Minimum number of LocalSearch Iterations 536 for :kroA200.tsp
    \item Maximum number of LocalSearch Iterations 561 for :kroA200.tsp
    \item Average number of LocalSearch Iterations 546.2 for :kroB200.tsp
    \item Minimum number of LocalSearch Iterations 525 for :kroB200.tsp
    \item Maximum number of LocalSearch Iterations 566 for :kroB200.tsp
\end{itemize}

ISL2:
\begin{itemize}
    \item Average number of LocalSearch Iterations 650.3 for :kroA200.tsp
    \item Minimum number of LocalSearch Iterations 462 for :kroA200.tsp
    \item Maximum number of LocalSearch Iterations 991 for :kroA200.tsp
    \item Average number of LocalSearch Iterations 495.8 for :kroB200.tsp
    \item Minimum number of LocalSearch Iterations 362 for :kroB200.tsp
    \item Maximum number of LocalSearch Iterations 621 for :kroB200.tsp
\end{itemize}
