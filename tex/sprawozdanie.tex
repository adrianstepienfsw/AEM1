...
\begin{center}
	\begin{tabular}{ l | l | l | l | l | l | l }
		\textbf{Pomiar} & \textbf{Wartość średnia celu} & \textbf{Wartość minimalna celu} & \textbf{Wartość maksymalna celu} & \textbf{Średni czas [ms]} & \textbf{Minimalny czas [ms]} & \textbf{Maksymalny czas [ms]} \\
		\hline
