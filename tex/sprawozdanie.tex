...
Wygeneruj listę wszystkich możliwych ruchów.
Powtarzaj:
    Sprawdź listę ruchów w poszukiwaniu ruchu do wykonania i wykonaj ruch:
        Przeszukiwanie listy w poszukiwaniu najlepszego aplikowalnego ruchu:
            Jeżeli typ ruchu to zamiana punktów:
                Sprawdź czy punkt do wymiany i jego sąsiedzi są w rozwiązaniu.
                Jeżeli wszystkie trzy punkty są w rozwiązaniu oraz punkt spoza rozwiązania rzeczywiście jest poza rozwiązaniem:
              		Zamień punkty do wymiany w tym ruchu.
              		Zapisz ruch jako wykonany ruch.
               		Dodaj ruch do listy ruchów do usunięcia.
              	W przeciwnym wypadku:
                	Dodaj ruch do listy ruchów do usunięcia.
            W przeciwnym wypadku jeżeli ruch to zamiana krawędzi:
            	Sprawdzenie czy ruch jest aplikowalny:
            		Jeżeli w rozwiązaniu są krawędzie do wymiany w tym ruchu i nie są to sąsiednie krawędzie:
...
Powtarzaj:
	Wygeneruj ruchy kandydackie:
   		Tworzenie ruchów wymiany wierzchołków:
        	Dla każdego punktu w rozwiązaniu:
            	Dla każdego punktu poza rozwiązaniem:
                	Oblicz deltę dla zamiany tych dwóch punktów (punktu w rozwiązaniu i punktu poza rozwiązaniem).
                	Jeżeli delta jest mniejsza od zera, to dodaj ten ruch do listy ruchów kandydackich.
   		Tworzenie ruchów wymiany krawędzi:
        	Dla każdej krawędzi w rozwiązaniu:
            	Dla najbliższych punktów do tej krawędzi:
                	Jeżeli ten punkt jest w rozwiązaniu:
                        Oblicz deltę dla zamiany krawędzi.
                        Jeżeli delta jest mniejsza od zera, to dodaj ten ruch do listy ruchów kandydackich.
 	Posortuj wygenerowane ruchy kandydackie od najlepszego do najgorszego.
	Jeżeli nie wygenerowano ruchów kandydackich lub wszystkie ruchy mają dodatnią deltę:
    	Przerwij zewnętrzną pętlę
	W przeciwnym wypadku:
